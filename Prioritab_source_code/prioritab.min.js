...
function CheckDayCountdown() {
    if (document.querySelector("#workday-checkbox").is(":checked")) {
...
window.onload = function () {
    ...
    browser.storage.sync.get(['user-workday-start', 'user-workday-end'], function (retrieved) {
        workdayStart = retrieved['user-workday-start'] ?? "09:00";
        workdayEnd = retrieved['user-workday-end'] ?? "18:00";
